 ...
 * com base em uma fonte de dados, que é uma lista de objetos do {@link Element}
 */
public class ElementAdapter extends ArrayAdapter<Element> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Retorne o layout do item da lista (contendo 3 TextViews) para que ele possa ser mostrado no
        // ListView.
        return listItemView;
    }
}
